...
// RUN: -hlo-legalize-to-linalg -arith-bufferize -empty-tensor-to-alloc-tensor \
// RUN: -tensor-bufferize -bufferization-bufferize \
...
func.func @reduce_add() {
  ...
  func.call @printMemrefF32(%unranked_input) : (memref<*xf32>) -> ()
