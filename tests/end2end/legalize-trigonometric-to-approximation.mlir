...
// RUN: --finalize-memref-to-llvm --convert-math-to-llvm --convert-func-to-llvm --convert-arith-to-llvm \
// RUN: -reconcile-unrealized-casts |\
// RUN: mlir-runner -e main -entry-point-result=void --shared-libs=%mlir_lib_dir/libmlir_runner_utils%shlibext |\
// RUN: FileCheck %s
