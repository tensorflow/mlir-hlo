...
// CHECK-FOR:         %[[MIN:.*]] = affine.min #map(%[[ARG2]])[%[[LHS_DIM_0]]]
...
// CHECK-PARALLEL:         %[[MIN:.*]] = affine.min #map(%[[ARG2]])[%[[LHS_DIM_0]]]
...
// CHECK-FOR:         %[[MIN_1:.*]] = affine.min #map(%[[ARG2_0]])[%[[LHS_DIM_0]]]
...
// CHECK-FOR:         %[[MIN:.*]] = affine.min #map(%[[I]])[%[[INIT_DIM_0]]]
...
// CHECK-FOR:         %[[MIN:.*]] = affine.min #map(%[[ARG4]])[%[[DIM]]]
...
// CHECK-FOR-DAG:     %[[TILE_SIZE0:.*]] = affine.min #map(%[[START0]])[%[[DIM0]]]
