...
LogicalResult ConvolutionOp::inferReturnTypeComponents(
  ...
  std::optional<DenseIntElementsAttr> padding = adaptor.getPadding();
  std::optional<DenseIntElementsAttr> lhsDilation = adaptor.getLhsDilation();
  std::optional<DenseIntElementsAttr> rhsDilation = adaptor.getRhsDilation();
