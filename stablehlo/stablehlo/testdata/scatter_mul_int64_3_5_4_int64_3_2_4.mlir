...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi64> {mhlo.layout_mode = "default"}, tensor<3x2x4xi64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[-1, 1, -2, -2], [3, 7, 2, 2], [6, 0, 0, -3], [0, 0, -2, -1], [7, 5, -4, 2]], [[1, 0, 0, 0], [2, -3, -2, 0], [0, -2, -4, -2], [-2, -2, 3, -2], [1, -3, -1, 1]], [[3, 2, -3, 1], [1, 3, 2, 0], [-6, -1, 1, 1], [0, 0, 0, 0], [0, -4, 0, 0]]]> : tensor<3x5x4xi64>
    %c_0 = stablehlo.constant dense<[[[3, -1, 3, -2], [6, 0, -3, -2]], [[-4, 0, 0, 1], [-1, -1, 4, 0]], [[0, 0, -1, -3], [-5, 2, -1, 1]]]> : tensor<3x2x4xi64>
    return %c, %c_0 : tensor<3x5x4xi64>, tensor<3x2x4xi64>
  }
  func.func private @expected() -> (tensor<3x5x4xi64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[-1, 1, -2, -2], [54, 0, -18, 8], [6, 0, 0, -3], [0, 0, -2, -1], [7, 5, -4, 2]], [[1, 0, 0, 0], [8, 0, 0, 0], [0, -2, -4, -2], [-2, -2, 3, -2], [1, -3, -1, 1]], [[3, 2, -3, 1], [0, 0, 2, 0], [-6, -1, 1, 1], [0, 0, 0, 0], [0, -4, 0, 0]]]> : tensor<3x5x4xi64>
