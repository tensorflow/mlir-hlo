...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<1xui32> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    %0:2 = call @inputs() : () -> (tensor<1xui32>, tensor<ui32>)
  ...
  func.func private @inputs() -> (tensor<1xui32> {mhlo.layout_mode = "default"}, tensor<ui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<5> : tensor<1xui32>
    %c_0 = stablehlo.constant dense<2> : tensor<ui32>
    return %c, %c_0 : tensor<1xui32>, tensor<ui32>
  }
  func.func private @expected() -> (tensor<1xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<10> : tensor<1xui32>
