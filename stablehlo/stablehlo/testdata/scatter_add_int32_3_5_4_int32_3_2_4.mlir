...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi32> {mhlo.layout_mode = "default"}, tensor<3x2x4xi32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[3, 0, -2, -4], [1, 0, 2, -5], [2, 0, 2, -5], [4, 1, -7, 0], [3, -4, 0, 0]], [[-4, 0, -4, 0], [-2, 0, 0, -2], [-3, -3, 0, 0], [2, 0, 1, 0], [3, -1, 5, 0]], [[0, -2, 0, 2], [-2, 4, -9, 2], [-3, 1, 0, 0], [5, 2, -1, 3], [-6, 0, -2, 0]]]> : tensor<3x5x4xi32>
    %c_0 = stablehlo.constant dense<[[[2, -2, 1, -1], [0, 0, 2, 5]], [[-2, 0, -2, -6], [0, 0, -3, 3]], [[4, -4, -3, 3], [3, 1, -2, 3]]]> : tensor<3x2x4xi32>
    return %c, %c_0 : tensor<3x5x4xi32>, tensor<3x2x4xi32>
  }
  func.func private @expected() -> (tensor<3x5x4xi32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[3, 0, -2, -4], [3, -2, 5, -1], [2, 0, 2, -5], [4, 1, -7, 0], [3, -4, 0, 0]], [[-4, 0, -4, 0], [-4, 0, -5, -5], [-3, -3, 0, 0], [2, 0, 1, 0], [3, -1, 5, 0]], [[0, -2, 0, 2], [5, 1, -14, 8], [-3, 1, 0, 0], [5, 2, -1, 3], [-6, 0, -2, 0]]]> : tensor<3x5x4xi32>
