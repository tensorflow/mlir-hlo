...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32> {mhlo.layout_mode = "default"}, tensor<1x3xf32> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[[-4.35935831, -2.26114631, 1.6267997], [1.7441932, 3.392230e+00, 2.58734846]]]> : tensor<1x2x3xf32>
    %cst_0 = stablehlo.constant dense<[[-1.06303251, 1.3039782, -5.03640127]]> : tensor<1x3xf32>
