...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi64> {mhlo.layout_mode = "default"}, tensor<2xi64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 0, 1], [0, -2, 3]], [[-2, 0, -2], [1, -4, -3]], [[0, -2, -1], [3, -1, -2]], [[0, -5, 1], [-4, 0, -7]]]> : tensor<4x2x3xi64>
    %c_0 = stablehlo.constant dense<[5, -4]> : tensor<2xi64>
    return %c, %c_0 : tensor<4x2x3xi64>, tensor<2xi64>
  }
  func.func private @expected() -> (tensor<4x2x3xi64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 0, 1], [0, -2, 3]], [[-2, 0, -2], [1, -4, -3]], [[0, -2, -1], [3, -1, -2]], [[0, -5, 6], [-4, 0, -11]]]> : tensor<4x2x3xi64>
