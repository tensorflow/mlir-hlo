...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<1x5xf32> {mhlo.layout_mode = "default"}, tensor<1xf32> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[-3.29836416, -0.472510606, 1.60520673, -1.61774409, 0.0900490731]]> : tensor<1x5xf32>
    %cst_0 = stablehlo.constant dense<-1.15384805> : tensor<1xf32>
