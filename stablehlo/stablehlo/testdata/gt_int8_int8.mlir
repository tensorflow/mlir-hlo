...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<i8> {mhlo.layout_mode = "default"}, tensor<i8> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<-2> : tensor<i8>
    %c_0 = stablehlo.constant dense<1> : tensor<i8>
    return %c, %c_0 : tensor<i8>, tensor<i8>
  }
