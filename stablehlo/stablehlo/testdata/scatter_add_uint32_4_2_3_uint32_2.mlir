...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui32> {mhlo.layout_mode = "default"}, tensor<2xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[4, 1, 5], [2, 2, 0]], [[3, 3, 4], [0, 3, 1]], [[0, 0, 3], [3, 1, 0]], [[2, 6, 3], [1, 2, 0]]]> : tensor<4x2x3xui32>
    %c_0 = stablehlo.constant dense<[1, 4]> : tensor<2xui32>
    return %c, %c_0 : tensor<4x2x3xui32>, tensor<2xui32>
  }
  func.func private @expected() -> (tensor<4x2x3xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[4, 1, 5], [2, 2, 0]], [[3, 3, 4], [0, 3, 1]], [[0, 0, 3], [3, 1, 0]], [[2, 6, 4], [1, 2, 4]]]> : tensor<4x2x3xui32>
