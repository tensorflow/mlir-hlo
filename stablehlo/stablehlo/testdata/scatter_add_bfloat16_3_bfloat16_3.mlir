...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3xbf16> {mhlo.layout_mode = "default"}, tensor<3xbf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[2.062500e+00, 3.328130e+00, 1.328130e+00]> : tensor<3xbf16>
    %cst_0 = stablehlo.constant dense<[1.031250e+00, 1.611330e-01, -2.750000e+00]> : tensor<3xbf16>
    return %cst, %cst_0 : tensor<3xbf16>, tensor<3xbf16>
  }
  func.func private @expected() -> (tensor<3xbf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[2.218750e+00, 1.625000e+00, 1.328130e+00]> : tensor<3xbf16>
