...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<2xui32> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    stablehlo.custom_call @check.expect_eq(%0, %1) {has_side_effect = true} : (tensor<2xui32>, tensor<2xui32>) -> ()
    return %0 : tensor<2xui32>
  }
  func.func private @inputs() -> (tensor<2xui32> {mhlo.layout_mode = "default"}) {
