...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui32> {mhlo.layout_mode = "default"}, tensor<2xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 3, 0], [4, 4, 1]], [[0, 2, 3], [2, 4, 1]], [[1, 4, 0], [1, 2, 2]], [[3, 6, 2], [0, 2, 0]]]> : tensor<4x2x3xui32>
    %c_0 = stablehlo.constant dense<[1, 2]> : tensor<2xui32>
    return %c, %c_0 : tensor<4x2x3xui32>, tensor<2xui32>
  }
  func.func private @expected() -> (tensor<4x2x3xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 3, 0], [4, 4, 1]], [[0, 2, 3], [2, 4, 1]], [[1, 4, 0], [1, 2, 2]], [[3, 6, 2], [0, 2, 2]]]> : tensor<4x2x3xui32>
