...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32> {mhlo.layout_mode = "default"}, tensor<2x3xf32> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[[-3.66318369, 0.427999586, -2.0378933], [5.78377867, 3.11127639, 2.98133254]]]> : tensor<1x2x3xf32>
    %cst_0 = stablehlo.constant dense<[[-2.59375572, 3.38117647, 2.97131467], [-1.14099371, 1.90498269, -1.09307444]]> : tensor<2x3xf32>
    return %cst, %cst_0 : tensor<1x2x3xf32>, tensor<2x3xf32>
  }
  func.func private @expected() -> (tensor<1x2x3xf32> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[[-3.66318369, 0.427999586, -2.0378933], [-1.14099371, 1.90498269, -1.09307444]]]> : tensor<1x2x3xf32>
