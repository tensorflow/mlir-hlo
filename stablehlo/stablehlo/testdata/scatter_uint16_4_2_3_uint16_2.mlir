...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui16> {mhlo.layout_mode = "default"}, tensor<2xui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 1, 2], [3, 7, 2]], [[2, 2, 0], [4, 2, 2]], [[0, 0, 0], [0, 0, 0]], [[0, 2, 1], [5, 0, 1]]]> : tensor<4x2x3xui16>
    %c_0 = stablehlo.constant dense<[1, 0]> : tensor<2xui16>
    return %c, %c_0 : tensor<4x2x3xui16>, tensor<2xui16>
  }
  func.func private @expected() -> (tensor<4x2x3xui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 1, 2], [3, 7, 2]], [[2, 2, 0], [4, 2, 2]], [[0, 0, 0], [0, 0, 0]], [[0, 2, 1], [5, 0, 0]]]> : tensor<4x2x3xui16>
