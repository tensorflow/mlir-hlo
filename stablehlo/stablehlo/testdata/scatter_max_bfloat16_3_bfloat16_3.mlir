...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3xbf16> {mhlo.layout_mode = "default"}, tensor<3xbf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[1.572270e-01, 6.000000e+00, 1.437500e+00]> : tensor<3xbf16>
    %cst_0 = stablehlo.constant dense<[-1.351560e+00, -5.531250e+00, -1.804690e+00]> : tensor<3xbf16>
