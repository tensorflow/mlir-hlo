...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi64> {mhlo.layout_mode = "default"}, tensor<3x2x4xi64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[0, -2, -2, 2], [9, 0, 3, 0], [3, 3, -3, 2], [3, 1, -2, 3], [-1, 0, 5, -4]], [[0, -1, -2, 0], [0, 3, -3, 6], [-3, -6, 2, 0], [-2, -3, 0, 1], [0, 1, 1, 0]], [[3, 4, -2, -3], [-1, 1, 0, 2], [0, -2, 0, -2], [-5, 1, 2, 0], [0, -1, 3, -2]]]> : tensor<3x5x4xi64>
    %c_0 = stablehlo.constant dense<[[[1, 0, -3, -3], [2, -5, 2, 6]], [[-1, 0, 2, -3], [4, 2, -5, -8]], [[3, 3, 2, 0], [0, 0, 3, 6]]]> : tensor<3x2x4xi64>
    return %c, %c_0 : tensor<3x5x4xi64>, tensor<3x2x4xi64>
  }
  func.func private @expected() -> (tensor<3x5x4xi64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[0, -2, -2, 2], [1, -5, -3, -3], [3, 3, -3, 2], [3, 1, -2, 3], [-1, 0, 5, -4]], [[0, -1, -2, 0], [-1, 0, -5, -8], [-3, -6, 2, 0], [-2, -3, 0, 1], [0, 1, 1, 0]], [[3, 4, -2, -3], [-1, 0, 0, 0], [0, -2, 0, -2], [-5, 1, 2, 0], [0, -1, 3, -2]]]> : tensor<3x5x4xi64>
