...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<1x2x3xi32> {mhlo.layout_mode = "default"}, tensor<2x3xi32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 0, 1], [-3, 1, 4]]]> : tensor<1x2x3xi32>
    %c_0 = stablehlo.constant dense<[[-2, 4, -1], [-1, 2, 3]]> : tensor<2x3xi32>
    return %c, %c_0 : tensor<1x2x3xi32>, tensor<2x3xi32>
  }
  func.func private @expected() -> (tensor<1x2x3xi32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 4, 1], [-1, 2, 4]]]> : tensor<1x2x3xi32>
