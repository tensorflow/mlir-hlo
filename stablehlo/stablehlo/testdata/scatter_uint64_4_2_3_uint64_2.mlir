...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui64> {mhlo.layout_mode = "default"}, tensor<2xui64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[0, 7, 5], [3, 4, 0]], [[0, 0, 0], [3, 0, 0]], [[4, 2, 1], [4, 0, 0]], [[0, 3, 2], [0, 2, 0]]]> : tensor<4x2x3xui64>
    %c_0 = stablehlo.constant dense<[0, 1]> : tensor<2xui64>
    return %c, %c_0 : tensor<4x2x3xui64>, tensor<2xui64>
  }
  func.func private @expected() -> (tensor<4x2x3xui64> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[0, 7, 5], [3, 4, 0]], [[0, 0, 0], [3, 0, 0]], [[4, 2, 1], [4, 0, 0]], [[0, 3, 0], [0, 2, 1]]]> : tensor<4x2x3xui64>
