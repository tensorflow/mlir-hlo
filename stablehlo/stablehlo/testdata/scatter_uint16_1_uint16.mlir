...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<1xui16> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    %0:2 = call @inputs() : () -> (tensor<1xui16>, tensor<ui16>)
  ...
  func.func private @inputs() -> (tensor<1xui16> {mhlo.layout_mode = "default"}, tensor<ui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<0> : tensor<1xui16>
    %c_0 = stablehlo.constant dense<1> : tensor<ui16>
    return %c, %c_0 : tensor<1xui16>, tensor<ui16>
  }
  func.func private @expected() -> (tensor<1xui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<1> : tensor<1xui16>
