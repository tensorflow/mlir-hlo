...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<ui8> {mhlo.layout_mode = "default"}, tensor<ui8> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<6> : tensor<ui8>
    %c_0 = stablehlo.constant dense<1> : tensor<ui8>
    return %c, %c_0 : tensor<ui8>, tensor<ui8>
  }
