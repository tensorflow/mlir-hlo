...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<3x3xf64> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    %2 = stablehlo.minimum %0#0, %0#1 : tensor<3x3xf64>
  ...
  func.func private @expected() -> (tensor<3x3xf64> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[0x7FF8000000000000, 0x7FF8000000000000, 0x7FF8000000000000], [0x7FF8000000000000, 0x7FF0000000000000, 0xFFF0000000000000], [0x7FF8000000000000, 0xFFF0000000000000, 0xFFF0000000000000]]> : tensor<3x3xf64>
