...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<1x2x3xui32> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    %0:2 = call @inputs() : () -> (tensor<1x2x3xui32>, tensor<2x3xui32>)
  ...
  func.func private @inputs() -> (tensor<1x2x3xui32> {mhlo.layout_mode = "default"}, tensor<2x3xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 2, 1], [4, 2, 0]]]> : tensor<1x2x3xui32>
    %c_0 = stablehlo.constant dense<[[0, 2, 3], [4, 2, 3]]> : tensor<2x3xui32>
    return %c, %c_0 : tensor<1x2x3xui32>, tensor<2x3xui32>
  }
  func.func private @expected() -> (tensor<1x2x3xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 4, 4], [8, 4, 3]]]> : tensor<1x2x3xui32>
