...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3xf64> {mhlo.layout_mode = "default"}, tensor<3xf64> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[-6.5386614213023408, -5.4019828352224977, -4.1475468008310488]> : tensor<3xf64>
    %cst_0 = stablehlo.constant dense<[3.148541605537992, 2.1009689421995792, -1.9134603133896197]> : tensor<3xf64>
