...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui32> {mhlo.layout_mode = "default"}, tensor<3x2x4xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 6, 1, 2], [2, 2, 2, 4], [3, 6, 1, 6], [0, 2, 1, 0], [2, 9, 5, 0]], [[6, 3, 0, 1], [0, 4, 3, 0], [0, 1, 5, 1], [2, 0, 1, 1], [1, 1, 2, 0]], [[3, 3, 2, 1], [2, 2, 1, 2], [0, 1, 1, 0], [0, 2, 3, 0], [4, 4, 2, 1]]]> : tensor<3x5x4xui32>
    %c_0 = stablehlo.constant dense<[[[0, 1, 1, 1], [5, 3, 4, 3]], [[3, 6, 2, 0], [4, 4, 5, 1]], [[3, 2, 1, 3], [6, 0, 1, 2]]]> : tensor<3x2x4xui32>
    return %c, %c_0 : tensor<3x5x4xui32>, tensor<3x2x4xui32>
  }
  func.func private @expected() -> (tensor<3x5x4xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 6, 1, 2], [0, 1, 1, 1], [3, 6, 1, 6], [0, 2, 1, 0], [2, 9, 5, 0]], [[6, 3, 0, 1], [0, 4, 2, 0], [0, 1, 5, 1], [2, 0, 1, 1], [1, 1, 2, 0]], [[3, 3, 2, 1], [2, 0, 1, 2], [0, 1, 1, 0], [0, 2, 3, 0], [4, 4, 2, 1]]]> : tensor<3x5x4xui32>
