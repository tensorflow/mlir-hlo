...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui16> {mhlo.layout_mode = "default"}, tensor<3x2x4xui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 1, 1, 2], [1, 0, 2, 1], [2, 1, 6, 5], [1, 1, 3, 2], [1, 2, 2, 0]], [[1, 2, 0, 1], [2, 1, 3, 0], [1, 1, 5, 0], [0, 3, 0, 1], [3, 1, 6, 2]], [[1, 0, 1, 3], [3, 1, 2, 0], [3, 4, 0, 1], [8, 6, 1, 3], [1, 0, 1, 3]]]> : tensor<3x5x4xui16>
    %c_0 = stablehlo.constant dense<[[[1, 1, 1, 3], [6, 2, 0, 0]], [[0, 3, 0, 2], [0, 1, 1, 1]], [[5, 2, 5, 2], [0, 1, 1, 2]]]> : tensor<3x2x4xui16>
    return %c, %c_0 : tensor<3x5x4xui16>, tensor<3x2x4xui16>
  }
  func.func private @expected() -> (tensor<3x5x4xui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 1, 1, 2], [8, 3, 3, 4], [2, 1, 6, 5], [1, 1, 3, 2], [1, 2, 2, 0]], [[1, 2, 0, 1], [2, 5, 4, 3], [1, 1, 5, 0], [0, 3, 0, 1], [3, 1, 6, 2]], [[1, 0, 1, 3], [8, 4, 8, 4], [3, 4, 0, 1], [8, 6, 1, 3], [1, 0, 1, 3]]]> : tensor<3x5x4xui16>
