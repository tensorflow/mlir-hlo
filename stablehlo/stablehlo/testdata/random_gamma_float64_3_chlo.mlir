...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<3xf64> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    %2 = call @"<lambda>"(%0) : (tensor<3xf64>) -> tensor<3xf64>
  ...
  func.func private @inputs() -> (tensor<3xf64> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[0.32999282409059688, 1.4493585479954081, 0.92543991796645963]> : tensor<3xf64>
    return %cst : tensor<3xf64>
  }
  func.func private @expected() -> (tensor<3xf64> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[0.0044547647687970997, 0.44586786372521875, 0.18356156921483407]> : tensor<3xf64>
    return %cst : tensor<3xf64>
  }
  func.func private @"<lambda>"(%arg0: tensor<3xf64> {mhlo.layout_mode = "default"}) -> (tensor<3xf64> {mhlo.layout_mode = "default"}) {
    ...
    %8 = call @_gamma(%7, %arg0) : (tensor<2xui32>, tensor<3xf64>) -> tensor<3xf64>
    return %8 : tensor<3xf64>
  }
  func.func private @_gamma(%arg0: tensor<2xui32> {mhlo.layout_mode = "default"}, %arg1: tensor<3xf64> {mhlo.layout_mode = "default"}) -> (tensor<3xf64> {mhlo.layout_mode = "default"}) {
    %0 = stablehlo.reshape %arg0 : (tensor<2xui32>) -> tensor<1x2xui32>
    %1 = call @_threefry_split(%0) : (tensor<1x2xui32>) -> tensor<1x3x2xui32>
    %2 = stablehlo.reshape %1 : (tensor<1x3x2xui32>) -> tensor<3x2xui32>
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f64>
    %3 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f64>) -> tensor<3xf64>
    %c = stablehlo.constant dense<0> : tensor<i64>
    %4:4 = stablehlo.while(%iterArg = %2, %iterArg_0 = %arg1, %iterArg_1 = %c, %iterArg_2 = %3) : tensor<3x2xui32>, tensor<3xf64>, tensor<i64>, tensor<3xf64>
     cond {
      %c_3 = stablehlo.constant dense<3> : tensor<i64>
      %5 = stablehlo.compare  LT, %iterArg_1, %c_3,  SIGNED : (tensor<i64>, tensor<i64>) -> tensor<i1>
      stablehlo.return %5 : tensor<i1>
    } do {
      %c_3 = stablehlo.constant dense<0> : tensor<i64>
      %5 = stablehlo.compare  LT, %iterArg_1, %c_3,  SIGNED : (tensor<i64>, tensor<i64>) -> tensor<i1>
      %6 = stablehlo.convert %iterArg_1 : tensor<i64>
      %c_4 = stablehlo.constant dense<3> : tensor<i64>
      %7 = stablehlo.add %6, %c_4 : tensor<i64>
      %8 = stablehlo.select %5, %7, %iterArg_1 : tensor<i1>, tensor<i64>
      %c_5 = stablehlo.constant dense<0> : tensor<i64>
      %9 = stablehlo.dynamic_slice %iterArg, %8, %c_5, sizes = [1, 2] : (tensor<3x2xui32>, tensor<i64>, tensor<i64>) -> tensor<1x2xui32>
      %10 = stablehlo.reshape %9 : (tensor<1x2xui32>) -> tensor<2xui32>
      %c_6 = stablehlo.constant dense<0> : tensor<i64>
      %11 = stablehlo.compare  LT, %iterArg_1, %c_6,  SIGNED : (tensor<i64>, tensor<i64>) -> tensor<i1>
      %12 = stablehlo.convert %iterArg_1 : tensor<i64>
      %c_7 = stablehlo.constant dense<3> : tensor<i64>
      %13 = stablehlo.add %12, %c_7 : tensor<i64>
      %14 = stablehlo.select %11, %13, %iterArg_1 : tensor<i1>, tensor<i64>
      %15 = stablehlo.dynamic_slice %iterArg_0, %14, sizes = [1] : (tensor<3xf64>, tensor<i64>) -> tensor<1xf64>
      %16 = stablehlo.reshape %15 : (tensor<1xf64>) -> tensor<f64>
      %17 = func.call @None_0(%10, %16) : (tensor<2xui32>, tensor<f64>) -> tensor<f64>
      %18 = stablehlo.broadcast_in_dim %17, dims = [] : (tensor<f64>) -> tensor<1xf64>
      %c_8 = stablehlo.constant dense<0> : tensor<i64>
      %19 = stablehlo.compare  LT, %iterArg_1, %c_8,  SIGNED : (tensor<i64>, tensor<i64>) -> tensor<i1>
      %20 = stablehlo.convert %iterArg_1 : tensor<i64>
      %c_9 = stablehlo.constant dense<3> : tensor<i64>
      %21 = stablehlo.add %20, %c_9 : tensor<i64>
      %22 = stablehlo.select %19, %21, %iterArg_1 : tensor<i1>, tensor<i64>
      %23 = stablehlo.dynamic_update_slice %iterArg_2, %18, %22 : (tensor<3xf64>, tensor<1xf64>, tensor<i64>) -> tensor<3xf64>
      %c_10 = stablehlo.constant dense<1> : tensor<i64>
      %24 = stablehlo.add %iterArg_1, %c_10 : tensor<i64>
      stablehlo.return %iterArg, %iterArg_0, %24, %23 : tensor<3x2xui32>, tensor<3xf64>, tensor<i64>, tensor<3xf64>
    }
    return %4#3 : tensor<3xf64>
  }
  func.func private @_threefry_split(%arg0: tensor<1x2xui32> {mhlo.layout_mode = "default"}) -> (tensor<1x3x2xui32> {mhlo.layout_mode = "default"}) {
    ...
    %7 = stablehlo.broadcast_in_dim %5, dims = [1] : (tensor<3xui32>) -> tensor<1x3xui32>
    ...
    %14 = stablehlo.broadcast_in_dim %9, dims = [0, 1] : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %15 = stablehlo.add %7, %14 : tensor<1x3xui32>
    %16 = stablehlo.broadcast_in_dim %10, dims = [0, 1] : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %17 = stablehlo.add %8, %16 : tensor<1x3xui32>
    %c_2 = stablehlo.constant dense<0> : tensor<i64>
    %c_3 = stablehlo.constant dense<0> : tensor<i64>
    %18:9 = stablehlo.while(%iterArg = %c_3, %iterArg_4 = %c_2, %iterArg_5 = %15, %iterArg_6 = %17, %iterArg_7 = %10, %iterArg_8 = %13, %iterArg_9 = %9, %iterArg_10 = %c, %iterArg_11 = %c_0) : tensor<i64>, tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>
     cond {
      %c_12 = stablehlo.constant dense<5> : tensor<i64>
      %21 = stablehlo.compare  LT, %iterArg, %c_12,  SIGNED : (tensor<i64>, tensor<i64>) -> tensor<i1>
      stablehlo.return %21 : tensor<i1>
    } do {
      %21:8 = func.call @None(%iterArg_4, %iterArg_5, %iterArg_6, %iterArg_7, %iterArg_8, %iterArg_9, %iterArg_10, %iterArg_11) : (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>) -> (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>)
      %c_12 = stablehlo.constant dense<1> : tensor<i64>
      %22 = stablehlo.add %iterArg, %c_12 : tensor<i64>
      stablehlo.return %22, %21#0, %21#1, %21#2, %21#3, %21#4, %21#5, %21#6, %21#7 : tensor<i64>, tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>
    }
    %19 = stablehlo.concatenate %18#2, %18#3, dim = 1 : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x6xui32>
    %20 = stablehlo.reshape %19 : (tensor<1x6xui32>) -> tensor<1x3x2xui32>
    return %20 : tensor<1x3x2xui32>
  }
  func.func private @None(%arg0: tensor<i64>, %arg1: tensor<1x3xui32>, %arg2: tensor<1x3xui32>, %arg3: tensor<1x1xui32>, %arg4: tensor<1x1xui32>, %arg5: tensor<1x1xui32>, %arg6: tensor<4xui32>, %arg7: tensor<4xui32>) -> (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>) {
    ...
    %3 = stablehlo.add %arg1, %arg2 : tensor<1x3xui32>
    %4 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %5 = stablehlo.shift_left %arg2, %4 : tensor<1x3xui32>
    %c_0 = stablehlo.constant dense<32> : tensor<ui32>
    %6 = stablehlo.subtract %c_0, %2 : tensor<ui32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %8 = stablehlo.shift_right_logical %arg2, %7 : tensor<1x3xui32>
    %9 = stablehlo.or %5, %8 : tensor<1x3xui32>
    %10 = stablehlo.xor %3, %9 : tensor<1x3xui32>
    %11 = stablehlo.slice %arg6 [1:2] : (tensor<4xui32>) -> tensor<1xui32>
    %12 = stablehlo.reshape %11 : (tensor<1xui32>) -> tensor<ui32>
    %13 = stablehlo.add %3, %10 : tensor<1x3xui32>
    %14 = stablehlo.broadcast_in_dim %12, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %15 = stablehlo.shift_left %10, %14 : tensor<1x3xui32>
    %c_1 = stablehlo.constant dense<32> : tensor<ui32>
    %16 = stablehlo.subtract %c_1, %12 : tensor<ui32>
    %17 = stablehlo.broadcast_in_dim %16, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %18 = stablehlo.shift_right_logical %10, %17 : tensor<1x3xui32>
    %19 = stablehlo.or %15, %18 : tensor<1x3xui32>
    %20 = stablehlo.xor %13, %19 : tensor<1x3xui32>
    %21 = stablehlo.slice %arg6 [2:3] : (tensor<4xui32>) -> tensor<1xui32>
    %22 = stablehlo.reshape %21 : (tensor<1xui32>) -> tensor<ui32>
    %23 = stablehlo.add %13, %20 : tensor<1x3xui32>
    %24 = stablehlo.broadcast_in_dim %22, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %25 = stablehlo.shift_left %20, %24 : tensor<1x3xui32>
    %c_2 = stablehlo.constant dense<32> : tensor<ui32>
    %26 = stablehlo.subtract %c_2, %22 : tensor<ui32>
    %27 = stablehlo.broadcast_in_dim %26, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %28 = stablehlo.shift_right_logical %20, %27 : tensor<1x3xui32>
    %29 = stablehlo.or %25, %28 : tensor<1x3xui32>
    %30 = stablehlo.xor %23, %29 : tensor<1x3xui32>
    %31 = stablehlo.slice %arg6 [3:4] : (tensor<4xui32>) -> tensor<1xui32>
    %32 = stablehlo.reshape %31 : (tensor<1xui32>) -> tensor<ui32>
    %33 = stablehlo.add %23, %30 : tensor<1x3xui32>
    %34 = stablehlo.broadcast_in_dim %32, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %35 = stablehlo.shift_left %30, %34 : tensor<1x3xui32>
    %c_3 = stablehlo.constant dense<32> : tensor<ui32>
    %36 = stablehlo.subtract %c_3, %32 : tensor<ui32>
    %37 = stablehlo.broadcast_in_dim %36, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %38 = stablehlo.shift_right_logical %30, %37 : tensor<1x3xui32>
    %39 = stablehlo.or %35, %38 : tensor<1x3xui32>
    %40 = stablehlo.xor %33, %39 : tensor<1x3xui32>
    %41 = stablehlo.broadcast_in_dim %arg3, dims = [0, 1] : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %42 = stablehlo.add %33, %41 : tensor<1x3xui32>
    %43 = stablehlo.broadcast_in_dim %arg4, dims = [0, 1] : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %44 = stablehlo.add %40, %43 : tensor<1x3xui32>
    %c_4 = stablehlo.constant dense<1> : tensor<i64>
    %45 = stablehlo.add %arg0, %c_4 : tensor<i64>
    %46 = stablehlo.convert %45 : (tensor<i64>) -> tensor<ui32>
    %47 = stablehlo.broadcast_in_dim %46, dims = [] : (tensor<ui32>) -> tensor<1x3xui32>
    %48 = stablehlo.add %44, %47 : tensor<1x3xui32>
    return %0, %42, %48, %arg4, %arg5, %arg3, %arg7, %arg6 : tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>
  }
