...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui8> {mhlo.layout_mode = "default"}, tensor<2xui8> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 3, 2], [0, 5, 1]], [[1, 1, 5], [6, 0, 0]], [[3, 0, 4], [5, 1, 1]], [[3, 7, 1], [2, 4, 4]]]> : tensor<4x2x3xui8>
    %c_0 = stablehlo.constant dense<[2, 3]> : tensor<2xui8>
    return %c, %c_0 : tensor<4x2x3xui8>, tensor<2xui8>
  }
  func.func private @expected() -> (tensor<4x2x3xui8> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, 3, 2], [0, 5, 1]], [[1, 1, 5], [6, 0, 0]], [[3, 0, 4], [5, 1, 1]], [[3, 7, 2], [2, 4, 12]]]> : tensor<4x2x3xui8>
