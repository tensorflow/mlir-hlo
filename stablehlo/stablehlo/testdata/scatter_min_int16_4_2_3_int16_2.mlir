...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi16> {mhlo.layout_mode = "default"}, tensor<2xi16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[0, 0, -3], [1, 0, 4]], [[6, 4, 0], [-2, -4, -1]], [[-1, -4, 1], [0, -3, 4]], [[2, 2, 2], [6, -1, 0]]]> : tensor<4x2x3xi16>
    %c_0 = stablehlo.constant dense<[1, 0]> : tensor<2xi16>
    return %c, %c_0 : tensor<4x2x3xi16>, tensor<2xi16>
  }
  func.func private @expected() -> (tensor<4x2x3xi16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[0, 0, -3], [1, 0, 4]], [[6, 4, 0], [-2, -4, -1]], [[-1, -4, 1], [0, -3, 4]], [[2, 2, 1], [6, -1, 0]]]> : tensor<4x2x3xi16>
