...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi8> {mhlo.layout_mode = "default"}, tensor<3x2x4xi8> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, -4, 0, 0], [5, 1, 1, 2], [-3, 0, 0, 0], [0, -3, 1, 0], [4, -1, 1, -4]], [[-2, -3, 1, 1], [3, 3, 1, 1], [0, 0, -1, -2], [7, 0, 0, 0], [4, 0, 4, -2]], [[9, 9, -2, -6], [-1, 3, 3, 3], [2, 2, 0, 0], [5, 2, -2, -1], [-7, 1, 1, -2]]]> : tensor<3x5x4xi8>
    %c_0 = stablehlo.constant dense<[[[3, 0, 0, 1], [0, 0, 3, 2]], [[-2, -4, 2, -3], [2, -1, 1, 0]], [[2, 0, 3, 0], [0, 6, 5, 0]]]> : tensor<3x2x4xi8>
    return %c, %c_0 : tensor<3x5x4xi8>, tensor<3x2x4xi8>
  }
  func.func private @expected() -> (tensor<3x5x4xi8> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[2, -4, 0, 0], [0, 0, 0, 4], [-3, 0, 0, 0], [0, -3, 1, 0], [4, -1, 1, -4]], [[-2, -3, 1, 1], [-12, 12, 2, 0], [0, 0, -1, -2], [7, 0, 0, 0], [4, 0, 4, -2]], [[9, 9, -2, -6], [0, 0, 45, 0], [2, 2, 0, 0], [5, 2, -2, -1], [-7, 1, 1, -2]]]> : tensor<3x5x4xi8>
