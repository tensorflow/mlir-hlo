...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32> {mhlo.layout_mode = "default"}, tensor<1xf32> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[[1.67161465, -1.0715816, -1.28259695], [-4.37396049, 5.35507441, 5.25238419]]]> : tensor<1x2x3xf32>
    %cst_0 = stablehlo.constant dense<-0.820538341> : tensor<1xf32>
    return %cst, %cst_0 : tensor<1x2x3xf32>, tensor<1xf32>
  }
  func.func private @expected() -> (tensor<1x2x3xf32> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[[1.67161465, -1.0715816, -1.28259695], [-4.37396049, 5.35507441, -4.30978251]]]> : tensor<1x2x3xf32>
