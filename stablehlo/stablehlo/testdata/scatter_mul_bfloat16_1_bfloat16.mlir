...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<1xbf16> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    %0:2 = call @inputs() : () -> (tensor<1xbf16>, tensor<bf16>)
  ...
  func.func private @inputs() -> (tensor<1xbf16> {mhlo.layout_mode = "default"}, tensor<bf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<2.109380e+00> : tensor<1xbf16>
    %cst_0 = stablehlo.constant dense<1.632810e+00> : tensor<bf16>
    return %cst, %cst_0 : tensor<1xbf16>, tensor<bf16>
  }
  func.func private @expected() -> (tensor<1xbf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<3.437500e+00> : tensor<1xbf16>
