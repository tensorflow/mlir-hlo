...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi32> {mhlo.layout_mode = "default"}, tensor<3x2x4xi32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, -7, 4, 1], [-4, 4, 5, 0], [2, 2, 5, 2], [-6, -3, 1, 2], [-1, 0, 3, -3]], [[-6, -1, 6, 1], [-2, 0, -3, 2], [1, 2, -3, -1], [-1, 3, 0, 5], [1, 0, 0, -2]], [[1, -3, 0, 4], [-2, -2, 0, -1], [-1, 2, 1, 2], [3, -1, 2, -1], [1, -3, 7, -3]]]> : tensor<3x5x4xi32>
    %c_0 = stablehlo.constant dense<[[[0, 0, 0, 1], [2, 0, -2, 0]], [[1, 0, -2, 2], [1, 4, 5, -1]], [[-1, 0, -2, 3], [0, -2, -1, 4]]]> : tensor<3x2x4xi32>
    return %c, %c_0 : tensor<3x5x4xi32>, tensor<3x2x4xi32>
  }
  func.func private @expected() -> (tensor<3x5x4xi32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, -7, 4, 1], [0, 0, 0, 0], [2, 2, 5, 2], [-6, -3, 1, 2], [-1, 0, 3, -3]], [[-6, -1, 6, 1], [-2, 0, 30, -4], [1, 2, -3, -1], [-1, 3, 0, 5], [1, 0, 0, -2]], [[1, -3, 0, 4], [0, 0, 0, -12], [-1, 2, 1, 2], [3, -1, 2, -1], [1, -3, 7, -3]]]> : tensor<3x5x4xi32>
