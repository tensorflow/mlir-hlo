...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main() -> (tensor<1xi16> {jax.result_info = "", mhlo.layout_mode = "default"}) {
    ...
    %0:2 = call @inputs() : () -> (tensor<1xi16>, tensor<i16>)
  ...
  func.func private @inputs() -> (tensor<1xi16> {mhlo.layout_mode = "default"}, tensor<i16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<-4> : tensor<1xi16>
    %c_0 = stablehlo.constant dense<3> : tensor<i16>
    return %c, %c_0 : tensor<1xi16>, tensor<i16>
  }
