...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3xf16> {mhlo.layout_mode = "default"}, tensor<3xf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[5.375000e+00, 1.994140e+00, 1.089060e+01]> : tensor<3xf16>
    %cst_0 = stablehlo.constant dense<[5.766600e-01, 1.218750e+00, -4.078130e+00]> : tensor<3xf16>
