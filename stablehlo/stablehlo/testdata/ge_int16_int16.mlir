...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<i16> {mhlo.layout_mode = "default"}, tensor<i16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<-2> : tensor<i16>
    %c_0 = stablehlo.constant dense<3> : tensor<i16>
    return %c, %c_0 : tensor<i16>, tensor<i16>
  }
