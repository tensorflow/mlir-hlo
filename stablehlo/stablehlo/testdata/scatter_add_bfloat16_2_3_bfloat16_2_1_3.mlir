...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<2x3xbf16> {mhlo.layout_mode = "default"}, tensor<2x1x3xbf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[2.046880e+00, 3.984380e+00, -1.343750e+00], [-6.367190e-01, 6.953130e-01, 1.632810e+00]]> : tensor<2x3xbf16>
    %cst_0 = stablehlo.constant dense<[[[-6.445310e-01, -1.234380e+00, 1.585940e+00]], [[7.000000e+00, -1.609380e+00, 5.156250e-01]]]> : tensor<2x1x3xbf16>
    return %cst, %cst_0 : tensor<2x3xbf16>, tensor<2x1x3xbf16>
  }
  func.func private @expected() -> (tensor<2x3xbf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[2.046880e+00, 3.984380e+00, -1.632810e+00], [-6.367190e-01, 6.953130e-01, 7.500000e+00]]> : tensor<2x3xbf16>
