...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi16> {mhlo.layout_mode = "default"}, tensor<3x2x4xi16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 0, 3, -2], [3, -1, -1, 1], [0, 2, -2, 1], [0, -1, 3, 0], [4, -3, 0, -3]], [[3, 0, 0, 0], [0, 4, 4, 2], [0, 0, 0, -4], [1, -1, -1, 0], [4, -3, 1, 1]], [[1, 0, -1, 1], [3, 1, -2, 0], [-4, 0, 1, -3], [-2, -3, 3, 2], [0, 0, 0, 2]]]> : tensor<3x5x4xi16>
    %c_0 = stablehlo.constant dense<[[[2, 1, -1, 2], [-3, 5, -1, 2]], [[-6, 0, -5, 0], [1, -4, -2, 0]], [[1, 1, 1, 0], [0, 2, 0, -3]]]> : tensor<3x2x4xi16>
    return %c, %c_0 : tensor<3x5x4xi16>, tensor<3x2x4xi16>
  }
  func.func private @expected() -> (tensor<3x5x4xi16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 0, 3, -2], [3, 5, -1, 2], [0, 2, -2, 1], [0, -1, 3, 0], [4, -3, 0, -3]], [[3, 0, 0, 0], [1, 4, 4, 2], [0, 0, 0, -4], [1, -1, -1, 0], [4, -3, 1, 1]], [[1, 0, -1, 1], [3, 2, 1, 0], [-4, 0, 1, -3], [-2, -3, 3, 2], [0, 0, 0, 2]]]> : tensor<3x5x4xi16>
