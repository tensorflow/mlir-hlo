...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<2x3xi1> {mhlo.layout_mode = "default"}, tensor<2x3xui32> {mhlo.layout_mode = "default"}, tensor<2x3xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<true> : tensor<2x3xi1>
    %c_0 = stablehlo.constant dense<[[0, 0, 0], [9, 0, 0]]> : tensor<2x3xui32>
    %c_1 = stablehlo.constant dense<[[2, 3, 2], [2, 3, 3]]> : tensor<2x3xui32>
    return %c, %c_0, %c_1 : tensor<2x3xi1>, tensor<2x3xui32>, tensor<2x3xui32>
  }
  func.func private @expected() -> (tensor<2x3xui32> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[2, 3, 2], [2, 3, 3]]> : tensor<2x3xui32>
