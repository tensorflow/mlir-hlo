...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3xf16> {mhlo.layout_mode = "default"}, tensor<3xf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[-3.320310e-02, 6.083980e-01, 2.894530e+00]> : tensor<3xf16>
    %cst_0 = stablehlo.constant dense<[1.019530e+00, 3.232420e+00, -2.771000e-01]> : tensor<3xf16>
    return %cst, %cst_0 : tensor<3xf16>, tensor<3xf16>
  }
  func.func private @expected() -> (tensor<3xf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[-3.320310e-02, -2.771000e-01, 2.894530e+00]> : tensor<3xf16>
