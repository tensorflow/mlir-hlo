...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<6xf32> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[0x7FC00000, 0x7FC00000, 2.000000e+00, -2.000000e+00, 0xFFC00000, 0xFFC00000]> : tensor<6xf32>
    return %cst : tensor<6xf32>
  }
  ...
  func.func private @argmin(%arg0: tensor<6xf32>) -> tensor<i32> {
    ...
    %c = stablehlo.constant dense<0> : tensor<i32>
    %1:2 = stablehlo.reduce(%arg0 init: %cst), (%0 init: %c) across dimensions = [0] : (tensor<6xf32>, tensor<6xi32>, tensor<f32>, tensor<i32>) -> (tensor<f32>, tensor<i32>)
