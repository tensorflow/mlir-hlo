...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<1x2xf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[[3.835940e+00, -6.488280e+00]]> : tensor<1x2xf16>
    return %cst : tensor<1x2xf16>
  }
  func.func private @expected() -> (tensor<2xf16> {mhlo.layout_mode = "default"}) {
    %cst = stablehlo.constant dense<[3.835940e+00, -6.488280e+00]> : tensor<2xf16>
