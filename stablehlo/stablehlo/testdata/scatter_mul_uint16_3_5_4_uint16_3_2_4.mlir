...
module @jit_main attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui16> {mhlo.layout_mode = "default"}, tensor<3x2x4xui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 0, 4, 0], [2, 0, 0, 4], [2, 0, 3, 2], [2, 0, 2, 0], [1, 0, 3, 0]], [[1, 7, 4, 4], [5, 0, 3, 3], [0, 1, 2, 2], [2, 0, 2, 3], [0, 1, 5, 4]], [[1, 1, 0, 1], [3, 0, 0, 0], [1, 0, 0, 4], [2, 0, 0, 1], [2, 0, 2, 2]]]> : tensor<3x5x4xui16>
    %c_0 = stablehlo.constant dense<[[[1, 2, 1, 5], [1, 0, 4, 1]], [[1, 2, 4, 1], [0, 0, 2, 1]], [[0, 2, 0, 1], [5, 1, 4, 2]]]> : tensor<3x2x4xui16>
    return %c, %c_0 : tensor<3x5x4xui16>, tensor<3x2x4xui16>
  }
  func.func private @expected() -> (tensor<3x5x4xui16> {mhlo.layout_mode = "default"}) {
    %c = stablehlo.constant dense<[[[1, 0, 4, 0], [2, 0, 0, 20], [2, 0, 3, 2], [2, 0, 2, 0], [1, 0, 3, 0]], [[1, 7, 4, 4], [0, 0, 24, 3], [0, 1, 2, 2], [2, 0, 2, 3], [0, 1, 5, 4]], [[1, 1, 0, 1], [0, 0, 0, 0], [1, 0, 0, 4], [2, 0, 0, 1], [2, 0, 2, 2]]]> : tensor<3x5x4xui16>
