...
// CHECK-LABEL: Evaluated results of function: floor_op_test_bf16
func.func @floor_op_test_bf16() -> tensor<9xbf16> {
...
// CHECK-LABEL: Evaluated results of function: floor_op_test_f16
func.func @floor_op_test_f16() -> tensor<9xf16> {
...
// CHECK-LABEL: Evaluated results of function: floor_op_test_f32
func.func @floor_op_test_f32() -> tensor<9xf32> {
...
// CHECK-LABEL: Evaluated results of function: floor_op_test_f64
func.func @floor_op_test_f64() -> tensor<9xf64> {
