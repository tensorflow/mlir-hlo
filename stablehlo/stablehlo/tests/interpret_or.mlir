...
// CHECK-LABEL: Evaluated results of function: or_op_test_si4
func.func @or_op_test_si4() -> tensor<3xi4> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_ui4
func.func @or_op_test_ui4() -> tensor<3xui4> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_si8
func.func @or_op_test_si8() -> tensor<3xi8> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_ui8
func.func @or_op_test_ui8() -> tensor<3xui8> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_si16
func.func @or_op_test_si16() -> tensor<3xi16> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_ui16
func.func @or_op_test_ui16() -> tensor<3xui16> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_si32
func.func @or_op_test_si32() -> tensor<3xi32> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_ui32
func.func @or_op_test_ui32() -> tensor<3xui32> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_si64
func.func @or_op_test_si64() -> tensor<3xi64> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_ui64
func.func @or_op_test_ui64() -> tensor<3xui64> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_i1
func.func @or_op_test_i1() -> tensor<4xi1> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_i1_splat_false
func.func @or_op_test_i1_splat_false() -> tensor<2xi1> {
...
// CHECK-LABEL: Evaluated results of function: or_op_test_i1_splat_true
func.func @or_op_test_i1_splat_true() -> tensor<2xi1> {
